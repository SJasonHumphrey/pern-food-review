      ...
      <div>
         <form action="">
             <div className="form-group">
                 ...
                 <input value={name} onChange={(e) => setName(e.target.value)} id="restaurant_name" className="form-control" type="text" />
             </div>
             <div className="form-group">
             ...
             <button type="submit" onClick={handleSubmit} className="btn btn-warning text-white mt-1">Submit</button>
         </form>
      </div>
  )
}
